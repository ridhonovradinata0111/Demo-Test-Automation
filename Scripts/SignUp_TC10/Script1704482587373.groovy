...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Free Online Form Builder  Form Creator_1350da/div_This email address is already associate_171465'), 
    'This email address is already associated with a Jotform account. Please Log in.')
